...
func _ready() -> void:
    ...
    Auth.connect("logout", Database, "_on_FirebaseAuth_logout")
    ...
    Auth.connect("logout", Firestore, "_on_FirebaseAuth_logout")
    ...
    Auth.connect("logout", Storage, "_on_FirebaseAuth_logout")