...
func execute(function: String, method: int, params: Dictionary = {}, body: Dictionary = {}) -> FunctionTask:
    ...
    function_task.task_error.connect(Callable(self, "_on_task_error"))
    function_task.task_finished.connect(Callable(self, "_on_task_finished"))
    function_task.function_executed.connect(Callable(self, "_on_function_executed"))
